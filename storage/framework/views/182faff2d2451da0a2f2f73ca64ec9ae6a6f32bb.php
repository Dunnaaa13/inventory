<?php $__env->startSection('content'); ?>
	<div class="container">
		<table class="table">
			<a class="btn btn-primary" align="center" href='/equipments/add' data-toggle="modal" data-target="#addModal">Add Item</a>
			<thead>
				<tr>
					<th scope="col">ID</th>
			...
			<tbody>
				<?php $__currentLoopData = $equipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						...
						<td><a class="btn btn-primary" href="/equipments/<?php echo e($equipment->id); ?>/delete">Delete</a></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ITE19-3C-2\Desktop\inventory_system\resources\views/equipments/index.blade.php ENDPATH**/ ?>